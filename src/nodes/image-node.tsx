...
function ImageNodeComponent(props: ImageNodeComponentProps): JSX.Element {
  return (
    <span style={{ display: 'flex', flexDirection: 'column', alignItems: JUSTIFY_MAP[props.alignment], margin: '8px 0' }}>
      <img src={props.src} alt={props.alt} width={props.width} height={props.height} style={{ maxWidth: '100%', borderRadius: 4 }} onError={(e) => { (e.currentTarget as HTMLImageElement).style.display = 'none'; }} />
      {props.caption && (
